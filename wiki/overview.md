...
- PRs #291–#299 are merged through PR #299 at merge `c0cc5183664648a11da8775abe8cd1a49ce91a51` from reviewed head `bbc6c6201bbf890a1662bcb59baaf24534407472`. The sequence adds measurable review UX, private Web Lab authoring/editing, safe receipts, linked-session recovery, declared spatial measurements, guided picking, and browser-local CV candidates. The CV rail is complementary to MCP/ChatGPT, not a replacement and not a reason to disable GPT, VLM, or SAM. Its proposals are local, editable, unchecked by default, provenance-bound, and kept outside Core until explicit confirmation. See `wiki/outputs/2026-07-31-post-pr299-local-cv-truth-sync.md`.
- Post-merge qualification reproduced one stale exact-string assertion in the recovery test, not a runtime or Core defect. The one-line test-only correction is open as PR #300 and is not yet part of `main`; the broader multi-image real-user matrix remains unverified.
