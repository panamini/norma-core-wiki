...
- The personal MVP is stable and this scope is closed. The next gate is observation-led maintenance: fix only reproduced bugs or demonstrated user needs; stop geometric expansion by default.
...
- Post-PR255 runtime promotion: `wiki/outputs/2026-07-21-post-pr255-runtime-promotion.md`
