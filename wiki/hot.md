...
## Current Focus
- Latest merged Norma Core state is PR #248 at `c406e1c0b20178b6d97299b466d6c35893873183`: PR #246 made ellipse review editable and responsive, PR #247 kept off-frame ellipse handles reachable, and PR #248 added one bounded manual-segment escape hatch.
- The stable private runtime is byte-identical to that exact main; build and suite `1722/1722` pass, with `/healthz=live` and `/readyz=ready`.
- The held-out matrix is `LIVE_MATRIX_PASS` for architecture/trapezoid, poster/refinement, and the ambiguous negative case; no Core bug was reproduced.
