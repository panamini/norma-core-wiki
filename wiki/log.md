...
- Clarified that Case 2 used one additional fresh isolated execution after a non-terminal surface attempt; it is explicitly not a functional retry because no accepted preparation, confirmation/Core call, provider call, or recovery action was repeated in the same conversation.
