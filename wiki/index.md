...
## Recent Additions
- `wiki/outputs/2026-07-15-personal-visual-harmony-checkpoint.md` current through PR #227
- `wiki/strategy/mvp-pr-roadmap.md` PR227 junction-angle capability and triangle-construction next gate
- `wiki/tech/core-interface-boundary.md` junction measurement provenance and non-Core authority boundary
- `wiki/overview.md` PR227 exact merge and verification sync
- `wiki/outputs/2026-07-03-post-pr99-package-tarball-local-install-checkpoint.md`
